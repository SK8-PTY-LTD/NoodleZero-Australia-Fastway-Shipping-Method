...
//                    echo '<pre>', print_r(json_encode($_product)), '</pre>';
                    echo '<pre>', print_r(json_encode($_product->bundled_data_items)), '</pre>';
                    echo '<pre>', print_r(json_encode($_product->bundled_item_quantities)), '</pre>';
                    echo '<pre>', print_r(json_encode($_product->contains)), '</pre>';
